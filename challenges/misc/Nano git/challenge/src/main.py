...
async def handle_upload(request: Request, file: UploadFile = File(...)):
    ...
    with tempfile.TemporaryDirectory(prefix="git_verification_") as temp_dir:
        try:
            ...
            # Step 4: git rev-list 037a118c4020f15c933b269580894e6587802818
            ...
            # Step 5: git checkout 037a118c4020f15c933b269580894e6587802818 && ./RunCICDChecks
            ...
            # Execute RunCICDChecks
            script_path = os.path.join(local_dir, "RunCICDChecks")
